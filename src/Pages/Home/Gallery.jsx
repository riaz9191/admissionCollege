...
const GalleryImage = ({ item }) => {
  ...
  return (
    <>
      <h2
        className="text-sm lg:text-xl font-semibold text-center text-gray-600 mb-4"
        data-aos="zoom-in"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6 mb-16">
        {item?.images.map((img, index) => (
          <img
            ...
            className="w-full object-cover object-center border-2 border-white shadow-md rounded"
...
const Gallery = () => {
  ...
  return (
    <div className="container mb-24">
      <h1
        className="text-xl lg:text-3xl font-semibold text-center uppercase text-orange-600 mb-10"
        data-aos="zoom-in"
        data-aos-easing="ease-out-cubic"
